...
public class Enemy_PursuitState : EnemyState
{
    ...
    public override EnemyStateMachine.EEnemyState GetNextState()
    {
        ...
        if (enemy.playerInMeleeRange && !enemy.canAttack || !enemy.ThereIsAFloor() || (enemy.ObjectTooHigh() && enemy.canJump) || !enemy.playerInPursuitRange || enemy.SimilarX) return EnemyStateMachine.EEnemyState.idle;
        ...
        if (enemy.ObjectForwardTooClose() && !enemy.ObjectTooHigh() && enemy.canJump) return EnemyStateMachine.EEnemyState.situateJump;
